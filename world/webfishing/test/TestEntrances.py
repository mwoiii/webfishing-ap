...
class TestEntrances(WebfishingTestBase):
    ...
    def test_t3_rare_catches(self) -> None:
        ...
        locations = [
            ...
            "King Salmon Quest (1/2)",
            "King Salmon Quest (2/2)",
            "Mooneye Quest (1/1)",
            "Pupfish Quest (1/1)",
            ...
            "Man O' War Quest (2/2)",
            "Manta Ray Quest (1/1)",
            "Sea Turtle Quest (1/2)",
            "Sea Turtle Quest (2/2)",
            "Squid Quest (1/2)",
            "Squid Quest (2/2)",
            "Whale Quest (1/1)",
            "Leedsichthys Quest (1/1)",
            "Catch High Tier Fish Quest (1/5)",
            "Catch High Tier Fish Quest (2/5)",
            "Catch High Tier Fish Quest (3/5)",
            "Catch High Tier Fish Quest (4/5)",
            "Catch High Tier Fish Quest (5/5)",
